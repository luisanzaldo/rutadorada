---
title: "Predicciones finales de los 98° Premios Oscar"
description: "Análisis y predicciones para los 98° Premios Oscar, destacando las categorías más reñidas y posibles ganadores."
pubDate: 2026-03-13T22:58:33.246Z
author: "Moncho"
letterboxd: "https://boxd.it/8jjEl"
authorImage: ""
image: "https://img.rutadoradafilms.com/4dc33f02261ac3d9.jpg"
category: "Premios"
fuente:
  nombre: "Redacción"
...
Por fin el gran día se acerca, ya estamos a pocas horas de la ceremonía de entrega de los premios **Óscar** de la Academia de Ciencias y Artes Cinematográficas de Hollywood. Este domingo 15 de marzo conoceremos a los ganadores, después de una temporada que se sintió larga debido a los tiempos entre ceremonias y la decisión de la Academia de alejar las fechas del periodo de votación. Ya conocemos todos los premios de las asociaciones de la crítica y la industria (los sindicatos), así como los televisados **Globos de Oro**, **BAFTA** y **Critics Choice**. Con base a lo que ha sucedido en estos meses, y lo que nos ha dado la Academia en el pasado, vamos a intentar predecir lo que va a suceder en esa esperada noche.

Este año la novedad es que los votantes tienen que "asegurar" que han visto todas las nominadas para poder elegir en alguna categoría, de lo contrario se abstienen. Pero es un voto de confianza lo de "asegurar" porque solo es marcar una casilla en el sistema por cada película "vista". En el pasado los académicos emitían su voto sin haber visto todo y daban el sufragio a la opción popular o a la única que los apasionaba, para evitar lo anterior se hicieron esos cambios que algunos muy probablemente respetaron (en muchas categorías ha estado habiendo abstencionismo este año o han votado hasta el último día para ver la mayor cantidad de películas), pero muchos otros seguramente seguirán cayendo en esas terribles costumbres. Es entendible, en algunos casos, que al ser miembros de la industria pues trabajan, hacen cine y no tienen tiempo de ver todo. Pero independientemente de eso creo que debe existir el compromiso férreo de ver lo más que puedan para votar por realmente lo que más les gusta en el año, pero eso es tema de otro debate. Ahora a lo que estamos aquí.
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">One Battle After Another</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Sinners</span>
      </div>
    </div>
  </div>
</div>

![PTG](https://preview.redd.it/paul-thomas-anderson-has-won-best-adapted-screenplay-at-the-v0-j7gx47b0j5lg1.jpeg?auto=webp&s=b22aef5d14f5047d6d2df15fb326449d977170f1)
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Paul Thomas Anderson (One Battle After Another)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Ryan Coogler (Sinners)</span>
      </div>
    </div>
  </div>
</div>
...
El triunfo de **Chalamet** es una posibilidad remota ya. Muy seguramente muchos no opinen lo mismo que yo, pero la pesada campaña que protagonizó, más la caída en desgracia de **Josh Safdie** (el director de su película) después de conocer cierto evento en el rodaje de **Good Time**, juegan en contra a un pobre **Timothée** que desea el triunfo más que nadie. **Marty Supreme** corre el riesgo de ser la gran perdedora de la noche, la mayoría no quiere premiar en algún lado a la película de un presunto consentidor de abuso sexual.
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Michael B. Jordan (Sinners)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Wagner Moura (The Secret Agent)</span>
      </div>
    </div>
  </div>
</div>
...
**Jessie Buckley** tiene el Oscar en una mano, el nombre ya grabado en la estatuilla y un pie arriba del **Dolby Theatre**. Nadie le va a quitar su triunfo, lo ha ganado todo y su actuación es magistral.
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Jessie Buckley (Hamnet)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Nadie, va a ganar Jessie</span>
      </div>
    </div>
  </div>
</div>

![actores](/images/actores.png)
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Sean Penn (One Battle After Another)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Delroy Lindo (Sinners) o Stellan Skarsgård (Sentimental Value)</span>
      </div>
    </div>
  </div>
</div>
...
Esta categoría está Igual de reñida que su contraparte masculina y a tres vías, por lo que hay emoción este año. **Amy Madigan** es el personaje de 2025 y probablemente de la década. Vivirá en el imaginario popular de la gente, ya que construye ese personaje con su increíble actuación; el triunfo debería ser para ella y, tras el **Actor Award** y el **Critics Choice**, así parece que será. Sin embargo, perdió el **Globo de Oro** ante una **Teyana Taylor** arrebatadora e inolvidable en sus únicos 30 minutos iniciales dentro de una de las mejores películas del año y que tiene más protagonismo en la ceremonia que el film de **Madigan**. Recordemos que ella tiene la única nominación para **Weapons** y las estadísticas le juegan en contra. Además, ni siquiera fue nominada al **BAFTA**, el premio lo ganó **Wunmi Mosaku** por su más que destacada actuación en **Sinners** y que estoy seguro fue su última escena la que la puso aquí, ¡está soberbia!
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Amy Madigan (Weapons)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Wunmi Mosaku (Sinners) o Teyana Taylor (One Battle After Another)</span>
      </div>
    </div>
  </div>
</div>
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Nadie</span>
      </div>
    </div>
  </div>
</div>
...
Se está dando una lucha encarnizada a dos vías entre el primer Oscar de Noruega o el segundo consecutivo para Brasil. Ambas películas son buenas, despiertan pasiones, grandes protagonistas y guiones bien escritos. Son muy diferentes entre sí. ¿Ganará la muy necesaria actual **O Agente Secreto** o se impondrá la íntima y compleja antología familiar **Affeksjonsverdi**?
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Sentimental Value (Noruega)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">The Secret Agent (Brasil)</span>
      </div>
    </div>
  </div>
</div>

![sentimental](https://www.hollywoodreporter.com/wp-content/uploads/2025/04/Sentimental-Value.jpg?w=1536&h=865&crop=1)
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">KPop Demon Hunters</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Zootopia 2</span>
      </div>
    </div>
  </div>
</div>
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">The Perfect Neighbor</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Mr. Nobody Against Putin o cualquiera de las otras nominadas</span>
      </div>
    </div>
  </div>
</div>
...
Esta es la categoría técnica más reñida. Cualquiera de los dos trabajos de fotografía de las grandes protagonistas de la noche puede ganar. La apuesta fácil es ir por **Michal Bauman**, que además de lograr imágenes nítidas y detalladas triunfó en el sindicato de fotografía **ASC** y el **BAFTA**, adicional a que el **VistaVision** ya ganó el año pasado con **The Brutalist**. Pero lo que hace **Autumn Durald Arkapaw** en **Sinners** es crear un trabajo inmersivo y técnico que utiliza principalmente película **IMAX** de 70mm y **Ultra Panavision 70** para lograr un aspecto crudo, íntimo y a la vez grandioso, por lo que su victoria iría más allá de un tema político, ya que se trata de la primera mujer filipina y de color en lograr una nominación.
...
![sinners](https://pbs.twimg.com/media/GpFPZ76XAAABdhv.jpg)
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">“Golden” (KPop Demon Hunters)</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">“I Lied to You” (Sinners)</span>
      </div>
    </div>
  </div>
</div>

![kpop](https://variety.com/wp-content/uploads/2025/06/KpopDemonHunters_ProRes422HQ_SDR_2ch_20250424.01_04_39_22-e1751348536322.jpg?w=1000&h=667&crop=1)

## Mejor Diseño de Vestuario, Mejor Diseño de Producción y Mejor Maquillaje
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Frankenstein</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
...
![frankenstein](https://media.outnow.ch/Movies/Bilder/2025/Frankenstein/006.jpg)
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Avatar: Fire and Ash</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">F1</span>
      </div>
    </div>
  </div>
</div>

En este año de votos nulos y abstencionismo, es aún más difícil apostar por una ganadora en las categorías de cortometraje. Si de por sí pocos miembros de la Academia ven algunos y aún así votan, ahora con la nueva regla menos gente va a votar. Así que aquí cualquiera podría ganar realmente y usar el tin marín de do pingüe para apostar por una ganadora, no debería descartarse como método de selección.
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">The Singers</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Podría ganar:</span>
        <span class="text-slate-700 dark:text-slate-300">Cualquiera de las otras nominadas</span>
      </div>
    </div>
  </div>
</div>
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">Butterfly</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
...
<div class="my-6 rounded-xl border border-[#F2AF0D]/20 bg-[#F2AF0D]/5 p-5 relative overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    <div class="flex items-start gap-3">
      ...
      <div>
        <span class="font-bold text-slate-900 dark:text-white">Predicción ganadora:</span>
        <span class="text-slate-700 dark:text-slate-300">The Devil Is Busy</span>
      </div>
    </div>
    <div class="flex items-start gap-3">
      <div class="rounded-full bg-slate-200 dark:bg-slate-700 p-1.5 text-slate-500 dark:text-slate-400 shrink-0 mt-0.5">
